    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().hasExtra("query") == true && getIntent().hasExtra("nounphrases") == true) {
            ...
            try {
                ...
                List<String> list = (List) nounphrasesMap.get("nounphrases");
        ...
        tv[10] = (TextView) findViewById(R.id.tvnounphrase11);
        tv[11] = (TextView) findViewById(R.id.tvnounphrase12);
        ...
        cardView[10] = (CardView) findViewById(R.id.nounphrase11);
        cardView[11] = (CardView) findViewById(R.id.nounphrase12);
    ...
    public void onClick(View view){
        switch(view.getId()){
            ...
            case R.id.nounphrase10:
                changeStatus(9);
                break;
            case R.id.nounphrase11:
                changeStatus(10);
                break;
            case R.id.nounphrase12:
                changeStatus(11);
                break;
            case R.id.tvRandom:
            ...
            case R.id.button:
                if(button.getText().equals("Confirm")){
                    ...
                    //TODO bei Abwahl: nächste Keyphrases rücken nach
                }
                break;
        }
    }
