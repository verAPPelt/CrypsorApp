...
public class ProgressBarActivityGetKeyqueries extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String nounphrasesParameter = "";
        for(String s : usedNounphrases){
            nounphrasesParameter += "&nounphrases="+s;
        }
